...
// (dsa_backend.py / forward_batch_deepseek_mha_mixin.py). These replace the
// pure-PyTorch fallbacks used before a CPU kernel existed.
...
// Mirrors create_flashinfer_kv_indices_triton (kv_indices.py).
